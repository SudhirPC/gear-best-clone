...
export const CheckoutPage = () => {
  return (
    <div className="ml-16 inputContainer">
        <div>
   {/* <img className="ml-16 w-56 h-28" src="https://uidesign.gbtcdn.com/GB/images/promotion/2019/a_evan/Gearbest/logo_gearbest.png" alt="" />  */}
       ...
       <div>
        ...
        <div>
            <button className="border-gray-700 border-2 mt-6 ml-16 text-black font-2xl font-semibold bg-yellow-300  w-40">Confirm</button>
        </div>
    </div>
    </div>
    </div>
