  ...
  return (
    <div className="ml-16 mt-4">
          ...
          <div className="w-11/12 h-28 mt-4 flex bg-gray-100">
            ...
            <div className="w-2/5 p-2 pt-8 pl-4 ml-60">
              ...
              <p className="line-through">
                RRP:{e.price + Math.ceil(Math.random(1 * 200))}
              </p>
            </div>
            ...
            <div className="w-2/5 p-2 pl-4 ml-6 mt-6 ">
              <button
                ...
                className="ml-4 bg-yellow-400 p-2  pl-4 pr-4 "
              >
                Delete
              </button>
            </div>
      ...
      <div className="ml-96 mt-4 flex">
        <div className="p-2 pr-4 bg-yellow-300 h-12 w-54">
          Total Price: ${total.toFixed(2)}
        </div>
        <Link to="/checkout">
          <button className="p-2 ml-96 pr-4 bg-yellow-600 text-black h-12 w-32">
            CheckOut
          </button>
        </Link>
      </div>
