  ...
  return (
    <div >
      <div className="mainbodyupper">
        ...
        <div className=" pl-4 hover:bg-gray-100">Cell Phones & Accessories</div>
        <div className=" pl-4 hover:bg-gray-100">Appliances</div>
        <div className=" pl-4 hover:bg-gray-100">Outdoors, Fitness & Sports</div>
        <div className=" pl-4 hover:bg-gray-100">Computers, Tablets & Office</div>
        <div className=" pl-4 hover:bg-gray-100">Health & Personal Care</div>
        <div className=" pl-4 hover:bg-gray-100">Home Improvement & Tools</div>
    ...
    <div  className=" ml-16 mt-10 mb-4">
      ...
      <div className="flex">
        ...
        <img className="w-44 h-56 mr-4" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSr5sVzgmpIQzputdBh7qkifvPDrzTCASHECA&usqp=CAU" alt="" />
        </div>
        <div className="shadow-2xl">
          <img className="w-44 h-56 mr-4" src="https://gloimg.gbtcdn.com/soa/gb/store/6507287161137004544/16430/goods_thumb_220-v3/e7514f266988.jpg" alt="" />
        </div>
        <div className="shadow-2xl">
          <img className="w-44 h-56 mr-4"  src="https://gloimg.gbtcdn.com/soa/gb/item/6878402251153666048/16519/goods_thumb_220-v1/e9c161b9300d.jpg" alt="" />
        </div>
        <div className="shadow-2xl">
        <img className="w-44 h-56 mr-4"  src="https://gloimg.gbtcdn.com/soa/gb/item/6900746726869757952/16492/goods_thumb_220-v3/0331f75f74f0.jpg" alt="" />
        </div>
        <div className="shadow-2xl">
        <img className="w-44 h-56 mr-4"  src="https://gloimg.gbtcdn.com/soa/gb/item/6878399324569661440/16517/goods_thumb_220-v1/a00cb9f65d8f.jpg" alt="" />
        </div>
        <div className="shadow-2xl">
