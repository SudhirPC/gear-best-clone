...
export const AddToCartBackend = (payload) => (dispatch) => {
  ...
  Axios.get(
    `https://gear-best-by-sudhir.herokuapp.com/cart/${userId}/${elemId}`
  )
    .then((response) => {
...
export const GetWatchDataFromEnd = (payload) => (dispatch) => {
  console.log(payload);
  Axios.get(
    `https://gear-best-by-sudhir.herokuapp.com/cart/product/watch/${payload}`
  )
    .then((response) => {
...
export const getIndividualData = (payload) => (dispatch) => {
  Axios.get(`https://gear-best-by-sudhir.herokuapp.com/watch/${payload}`)
    .then((response) => {
      console.log(response.data);
