...
export const ProductPage = () => {
  ...
  const getWatchBrand = (brand) => {
    axios
      .get(
        `https://gear-best-by-sudhir.herokuapp.com/watch/filter/brand/${brand}`
      )
      .then((res) => {
  ...
  const getWatchGender = (gender) => {
    axios
      .get(
        `https://gear-best-by-sudhir.herokuapp.com/watch/filter/gender/${gender}`
      )
      .then((res) => {
          ...
          <div className="ml-12 mt-4">
            ...
            <div className="mt-8">
              ...
              <div className="flex mt-4">
                ...
                <div className="flex ">
                  <button
                    ...
                    className="bg-yellow-400 ml-2 p-2"
                  >
                    Ascending
                  </button>
                  <button
                    ...
                    className="bg-yellow-400 ml-6 p-2"
                  >
                    Decending
                  </button>
                </div>
              ...
              <div className="flex mt-4">
                ...
                <div className="flex ">
                  <button
                    className="bg-yellow-400 ml-6 p-2 pl-4"
                    onClick={() => {
                      setGender("male");
                    }}
                  >
            ...
            <div className="w-11/12 ml-4 mt-8 h-full">
                  ...
                  return (
                    ...
                    >
                      <div className=" mb-1">
                        ...
                        <div className="bg-yellow-500 rounded-md w-28 pl-2 ml-2">
                          {e.gender} Watch
                        </div>
                        <button
                          onClick={() => {
                            AddWatchToCart(e._id);
                          }}
                          className="bg-red-300 rounded-md mt-1 p-2 ml-2"
                        >
                          Add To Cart
                        </button>
              ...
              <Link to="/cart">
                <button className="bg-yellow-500 rounded-md mt-1  p-2 ml-96">
                  Go To Cart
                </button>
              </Link>
            </div>
