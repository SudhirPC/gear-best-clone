 ...
 {/* { right product body}  */}
        ...
        <div className="ml-12 mt-4">
            ...
            <div className="flex">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                <path stroke-linecap="round" strokeLinejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                </svg>
                </div>
            ...
            <div className="mt-8">
                <div className="flex">
                    <div>Brand: </div> 
                    <div className="flex">
                        <img className="w-16 h-8 border-2 ml-2 mr-4" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8UCNQKy0bALKNfQnfIW3JphY8xbh_QPOppQ&usqp=CAU" alt="huawei" />
                        <img className="w-16 h-8 border-2 ml-1 mr-4" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTddNTwBlzDZxFRp1ikyE2wspgLefe9MqbYEw&usqp=CAU" alt="x3" />
                        <img className="w-16 h-8 border-2 ml-1 mr-4"  src="https://uidesign.gbtcdn.com/GB/image/6874/150x73.jpg" alt="xiomi" />
                        <img className="w-16 h-8 border-2 ml-1 mr-4"  src="https://uidesign.gbtcdn.com/GB/image/brand/20181102_5779/amazfit.jpg?impolicy=hight" alt="amazefit" />
                        <img className="w-16 h-8 border-2 ml-1"  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRM8PCSHrC3ZkE8y6elnZuMTNqvnWQtnS1Zdg&usqp=CAU" alt="apple" />
                    </div>
                </div>
